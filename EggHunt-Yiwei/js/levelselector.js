		...
		for (var i = 0; i < collectedCandy.length; i++) {
			...
			for(var j = 0; j < 3; j++) {
				if(levelCandy[j] == "1") {
					...
					{
					  case 0:
						$("#candy"+(i+1)+"1").attr("src", "img/theme3/collectible1.png");
					    break;
					  case 1:
						$("#candy"+(i+1)+"2").attr("src", "img/theme3/collectible1.png");
					    break;
					  case 2:
						$("#candy"+(i+1)+"3").attr("src", "img/theme3/collectible1.png");
					    break;
					  default:
					...
					{
					  case 0:
						$("#candy"+(i+1)+"1").attr("src", "img/theme3/collectible1_bw.png");
					    break;
					  case 1:
						$("#candy"+(i+1)+"2").attr("src", "img/theme3/collectible1_bw.png");
					    break;
					  case 2:
						$("#candy"+(i+1)+"3").attr("src", "img/theme3/collectible1_bw.png");
					    break;
					  default:
					    alert("Error could not load candy" + j);
					}
