...
//	var debugDraw = new b2DebugDraw();
	...
	if(loadSceneFromRUBE(level9scene)){
	...
	level9Timer = window.setInterval(update, 1000 / 60);
	
	var basket = new b2AABB;
	basket.lowerBound = new b2Vec2(500/30, 275/30);
	basket.upperBound = new b2Vec2(540/30, 325/30);
...
//	     world.DrawDebugData();
	     draw();
//	 	 context.drawImage(image, 45, 0, 180, 200, 450, 120, 80, 80);
	 	 context.drawImage(image, 445, 95);
