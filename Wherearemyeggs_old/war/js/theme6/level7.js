...
//	var debugDraw = new b2DebugDraw();
	...
	if(loadSceneFromRUBE(level7scene)){
	...
	level7Timer = window.setInterval(update, 1000 / 60);
	
	var basket = new b2AABB;
	basket.lowerBound = new b2Vec2(500/30, 0/30);
	basket.upperBound = new b2Vec2(550/30, 80/30);
...
//	     world.DrawDebugData();
	     draw();
//	 	 context.drawImage(image, 45, 0, 180, 200, 520, 330, 80, 80);
	 	 context.drawImage(image, 520, 330);
