...
//	var debugDraw = new b2DebugDraw();
	...
	if(loadSceneFromRUBE(level2scene)){
	...
	level2Timer = window.setInterval(update, 1000 / 60);
	
	var basket = new b2AABB;
	basket.lowerBound = new b2Vec2(260/30, 30/30);
	basket.upperBound = new b2Vec2(290/30, 60/30);
...
//	     world.DrawDebugData();
	     draw();
//	 	 context.drawImage(image, 45, 0, 180, 200, 260, 330, 80, 80);
	 	 context.drawImage(image, 260, 330);
