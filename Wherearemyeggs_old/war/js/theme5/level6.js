  ...
  function init() {
   ...
   // img.addEventListener("load", function() {
    ...
    //create level1
     ...
     var launcher1 = new Body(physics, { color: "red", type: "static", x: 5, y:13, height: 0.5, width: 08 });
     launcher1.contact = function(bodyA) {
        ...
        var launcher2 = new Body(physics, { color: "red", type: "static", x: 20, y:18, height: 0.5, width: 25 });
     ...
     var red =  new Body(physics, { image: redImage ,type: "static", x: 36, y:12});
     ...
     var bomb = new Body(physics, { image: bombImage ,type: "static", x: 22, y: 12});
