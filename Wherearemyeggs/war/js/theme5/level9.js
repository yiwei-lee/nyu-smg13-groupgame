  ...
  function init() {
   ...
   // img.addEventListener("load", function() {
     ...
     ground.elementType = "ground"
    	 ...
    	 new Body(physics, { color: "brown", type: "static", x: 05, y:10, height: 0.5,  width: 5 });
    //create level5
         //create image
/*         var brickImage = new Image();
     brickImage.src = "img/theme5/brickwall.jpg";
        var brick = new Body(physics, { image: brickImage ,type: "static", x: 33, y: 5});
        brick.elementType = "breakable";*/
      
      
      var launcher1 = new Body(physics, { color: "red", type: "static", x: 5, y:21, height: 0.5, width: 5 });
      launcher1.contact = function(bodyA) {
       	  
    	  egg.body.ApplyImpulse({ x: 0, y: 500 }, egg.body.GetWorldCenter());
           
         };
         
         var launcher2 = new Body(physics, { color: "red", type: "static", x: 33, y:15, height: 0.5, width: 5 });
         launcher2.contact = function(bodyA) {
          	  
       	  egg.body.ApplyImpulse({ x: 0, y: 500 }, egg.body.GetWorldCenter());
              
            };
         
            var launcher3 = new Body(physics, { color: "red", type: "static", x: 18, y:12, height: 10, width: 3 });
            launcher3.contact = function(bodyA) {
             	  
          	  egg.body.ApplyImpulse({ x: 350, y: 0 }, egg.body.GetWorldCenter());
           ...
           /*var bomb = new Body(physics, { image: bombImage ,type: "static", x: 3, y: 3});
           bomb.elementType = "bomb";*/
           
           var bomb1 = new Body(physics, { image: bombImage ,type: "static",  x: 38, y: 2});
           bomb1.elementType = "bomb";
           
           var bomb2 = new Body(physics, { image: bombImage ,type: "static",  x: 28, y: 2});
           bomb2.elementType = "bomb";
      
      //create basket
      //basket image
      var basketImage = new Image();
      basketImage.src = "img/theme5/basket.png";
     var basket = new Body(physics, { image: basketImage ,type: "static", x: 5, y: 8});
     basket.elementType = "basket";
      
      var redImage = new Image();
      redImage.src = "img/theme5/collectible1.png";
     var red =  new Body(physics, { image: redImage ,type: "static", x: 37, y:12	});
     ...
     var blue =  new Body(physics, { image: blueImage ,type: "static", x: 5, y:15});
     ...
     var tree =  new Body(physics, { image: treeImage ,type: "static",x: 14, y:18});
     ...
     var body = new Body(physics, { image: eggImage , x: 33, y: 1, height : 2, width : 1.8 });
     body.elementType = "egg"
      ...
      physics.click(function(body) {
    	  if(body.GetUserData().elementType == "breakable"){
