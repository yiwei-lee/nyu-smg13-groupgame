  ...
  function init() {
   ...
   // img.addEventListener("load", function() {
    ...
    //create level1
    	 ...
    	 var launcher1 = new Body(physics, { color: "red", type: "static", x: 15, y:9, height: 0.5, width: 08 });
     launcher1.contact = function(bodyA) {
        ...
        var launcher2 = new Body(physics, { color: "red", type: "static", x: 33, y:20, height: 0.5, width: 08 });
        launcher2.contact = function(bodyA) {
           ...
           var launcher3 = new Body(physics, { color: "red", type: "static", x: 1, y:12, height: 15, width: 2 });
           launcher3.contact = function(bodyA) {
            	  
         	  egg.body.ApplyImpulse({ x: 500, y: 0 }, egg.body.GetWorldCenter());
     ...
     var basket = new Body(physics, { image: basketImage ,type: "static", x: 15, y: 18});
     basket.elementType = "basket";
      
      var redImage = new Image();
      redImage.src = "img/theme5/collectible1.png";
     var red =  new Body(physics, { image: redImage ,type: "static", x: 38, y: 3});
     ...
     var blue =  new Body(physics, { image: blueImage ,type: "static", x: 5, y:3});
     ...
     var tree =  new Body(physics, { image: treeImage ,type: "static",x: 22, y:12});
     ...
     /*var bomb = new Body(physics, { image: bombImage ,type: "static", x: 26, y: 10});
     bomb.elementType = "bomb";*/
     
     var bomb1 = new Body(physics, { image: bombImage ,type: "static", x: 22, y: 15});
