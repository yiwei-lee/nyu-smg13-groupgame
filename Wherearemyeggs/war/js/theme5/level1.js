...
function level1(){
  ...
  function init() {
   ...
   // img.addEventListener("load", function() {
    ...
    //create level1
      new Body(physics, { color: "brown", type: "static", x: 1, y:6, height: 0.5, width: 30 });
      
      new Body(physics, { color: "brown", type: "static", x: 40, y:15, height: 0.5, width: 15 });
     ...
     var red =  new Body(physics, { image: redImage ,type: "static", x: 33, y:12});
     ...
     var blue =  new Body(physics, { image: blueImage ,type: "static", x: 20, y:6});
     ...
     var tree =  new Body(physics, { image: treeImage ,type: "static", x: 02, y:3});
     ...
     var body = new Body(physics, { image: eggImage , x: 8, y: 1, height : 2, width : 1.8 });
