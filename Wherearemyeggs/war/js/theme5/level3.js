...
function level3(){
  ...
  function init() {
   ...
   // img.addEventListener("load", function() {
    ...
    //create level1
      new Body(physics, { color: "brown", type: "static", x: 1, y:8, height: 0.5, width: 30 });
      
      
      var launcher = new Body(physics, { color: "red", type: "static", x: 40, y:15, height: 0.5, width: 15 });
      launcher.contact = function(bodyA) {
     ...
     var basket = new Body(physics, { image: basketImage ,type: "static", x: 20, y: 18});
     basket.elementType = "basket";
      
      var redImage = new Image();
      redImage.src = "img/theme5/collectible1.png";
     var red =  new Body(physics, { image: redImage ,type: "static", x: 33, y:3});
     ...
     var blue =  new Body(physics, { image: blueImage ,type: "static", x: 10, y:3});
     ...
     var tree =  new Body(physics, { image: treeImage ,type: "static", x: 12, y:13});
     ...
     var bomb = new Body(physics, { image: bombImage ,type: "static", x: 28, y: 15});
