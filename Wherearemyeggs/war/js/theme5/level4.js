...
function level4(){
  ...
  function init() {
   ...
   // img.addEventListener("load", function() {
     ...
     var launcher1 = new Body(physics, { color: "red", type: "static", x: 10, y:20, height: 0.5, width: 8 });
     launcher1.contact = function(bodyA) {
        ...
        var launcher2 = new Body(physics, { color: "red", type: "static", x: 27, y:15, height: 0.5, width: 15 });
     ...
     var basket = new Body(physics, { image: basketImage ,type: "static", x: 36, y: 18});
     ...
     var tree =  new Body(physics, { image: treeImage ,type: "static", x: 3, y:3});
     ...
     var bomb = new Body(physics, { image: bombImage ,type: "static", x: 3, y: 6});
