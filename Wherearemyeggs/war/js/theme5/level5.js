...
function level5(){
  ...
  function init() {
   ...
   // img.addEventListener("load", function() {
    ...
    //create level1
      new Body(physics, { color: "brown", type: "static", x: 1, y:8, height: 0.5, width: 10 });
      
      
     var launcher1 = new Body(physics, { color: "red", type: "static", x: 15, y:20, height: 0.5, width: 08 });
     launcher1.contact = function(bodyA) {
        ...
        var launcher2 = new Body(physics, { color: "red", type: "static", x: 30, y:15, height: 0.5, width: 08 });
     ...
     var basket = new Body(physics, { image: basketImage ,type: "static", x: 30, y: 3});
     basket.elementType = "basket";
      
      var redImage = new Image();
      redImage.src = "img/theme5/collectible1.png";
     var red =  new Body(physics, { image: redImage ,type: "static", x: 30, y:12});
     ...
     var tree =  new Body(physics, { image: treeImage ,type: "static", x: 10, y: 15});
     ...
     var bomb = new Body(physics, { image: bombImage ,type: "static", x: 22, y: 18});
    ...
    var body = new Body(physics, { image: eggImage , x: 3, y: 1, height : 2, width : 1.8 });
