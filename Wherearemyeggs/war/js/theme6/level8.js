...
//	var debugDraw = new b2DebugDraw();
	...
	if(loadSceneFromRUBE(level8scene)){
	...
	level8Timer = window.setInterval(update, 1000 / 60);
	
	var basket = new b2AABB;
	basket.lowerBound = new b2Vec2(500/30, 300/30);
	basket.upperBound = new b2Vec2(550/30, 340/30);
...
//	     world.DrawDebugData();
	     draw();
	 	 context.drawImage(image, 520, 110);
