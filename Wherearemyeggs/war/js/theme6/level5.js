...
//	var debugDraw = new b2DebugDraw();
	...
	if(loadSceneFromRUBE(level5scene)){
	...
	level5Timer = window.setInterval(update, 1000 / 60);
	
	var basket = new b2AABB;
	basket.lowerBound = new b2Vec2(330/30, 0/30);
	basket.upperBound = new b2Vec2(420/30, 120/30);
...
//	 	 context.drawImage(image, 45, 0, 180, 200, 360, 330, 80, 80);
	 	 context.drawImage(image, 347, 294);
