...
//	var debugDraw = new b2DebugDraw();
	...
	if(loadSceneFromRUBE(level3scene)){
	...
	level3Timer = window.setInterval(update, 1000 / 60);
	
	var basket = new b2AABB;
	basket.lowerBound = new b2Vec2(75/30, 300/30);
	basket.upperBound = new b2Vec2(120/30, 400/30);
...
//	     world.DrawDebugData();
	     draw();
//	 	 context.drawImage(image, 45, 0, 180, 200, 80, 110, 80, 80);
	 	 context.drawImage(image, 75, 100);
