...
//    src = assetsPath+"basketReached.mp3";
...
//    createjs.Sound.addEventListener("fileload", createSoundInstance); // add an event listener for when load is completed
//    createjs.Sound.registerSound(src);  // register sound, which preloads by default
    ...
    //touch
//    var activateSoundsMobile = true;
    document.addEventListener('touchstart', function(event) {
//    	   if(activateSoundsMobile){
//        	   basketSound.setMute(true);
//        	   basketSound.setVolume(0);
//    		   basketSound.play();
//        	   activateSoundsMobile = false;
//    	   }
...
//		   basketSound.setMute(false);
//		   basketSound.setVolume(1);
           isMouseDown = false;
           mouseX = undefined;
           mouseY = undefined;
           }, false);
...
//	var debugDraw = new b2DebugDraw();
	...
	if(loadSceneFromRUBE(level6scene)){
	...
	level6Timer = window.setInterval(update, 1000 / 60);
	
	var basket = new b2AABB;
	basket.lowerBound = new b2Vec2(455/30, 200/30);
	basket.upperBound = new b2Vec2(480/30, 230/30);
...
//	     world.DrawDebugData();
	     draw();
//	 	 context.drawImage(image, 45, 0, 180, 200, 410, 180, 80, 80);
	 	 context.drawImage(image, 400, 180);
...
//				  basketSound.play(); // Play just one time.
//			  }
			  goalReached = true;
		  }
	}
